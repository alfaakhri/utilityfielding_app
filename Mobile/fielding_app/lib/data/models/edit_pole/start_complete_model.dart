...
class StartCompleteModel {
  String? token;
  bool? isStartAdditional;
  String? startTimer;
  String? endTimer;
  String? id;
  String? layerId;
  ...
  StartCompleteModel.fromJson(Map<String, dynamic> json) {
    token = json['Token'];
    isStartAdditional = json['IsStartAdditional'];
    startTimer = json['StartTimer'];
    endTimer = json['EndTimer'];
    id = json['Id'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['IsStartAdditional'] = this.isStartAdditional;
  ...
  static List<StartCompleteModel>? fromJsonList(jsonList) {
    return jsonList
        .map<StartCompleteModel>((obj) => StartCompleteModel.fromJson(obj))
        .toList();
  }
}
