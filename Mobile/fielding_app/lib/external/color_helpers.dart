...
class ColorHelpers {
  static const Color colorBackground = const Color(0xFFF4F5FA);
  static const Color colorBorder = const Color(0xFFCCCCCC);
  static const Color colorDefault = const Color(0xFFAEAEAE);
  static const Color colorOrange = const Color(0xFFF39C12);
  static const Color colorGreen = const Color(0xFF27AE60);
  static const Color colorGreen2 = const Color(0xFF2ECC71);
  ...
  static const colorBrown =  Color(0xFF997950);
